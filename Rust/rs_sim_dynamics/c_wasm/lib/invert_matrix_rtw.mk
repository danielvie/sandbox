###########################################################################
## Makefile generated for component 'invert_matrix'. 
## 
## Makefile     : invert_matrix_rtw.mk
## Generated on : Fri Nov 10 01:46:40 2023
## Final product: ./invert_matrix.a
...
PRODUCT_NAME              = invert_matrix
MAKEFILE                  = invert_matrix_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2022a.app
MATLAB_BIN                = /Applications/MATLAB_R2022a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/danielvieira/Documents/doutorado.git/z_tutoriais/play
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/invert_matrix -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=invert_matrix
...
SRCS = $(START_DIR)/codegen/lib/invert_matrix/invert_matrix.c
...
%.o : $(START_DIR)/codegen/lib/invert_matrix/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/invert_matrix/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
invert_matrix.o : $(START_DIR)/codegen/lib/invert_matrix/invert_matrix.c
	$(CC) $(CFLAGS) -o "$@" "$<"
